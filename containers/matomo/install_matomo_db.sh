...
mysql -u root -p@DB_PASSWORD@ matomo -e 'UPDATE user SET login = "@MATOMO_PUBLIC_USER@" WHERE login = "viewer";'
mysql -u root -p@DB_PASSWORD@ matomo -e 'UPDATE user SET password = "@MATOMO_PUBLIC_USER_PASSWORD@" WHERE login = "@MATOMO_PUBLIC_USER@";'
mysql -u root -p@DB_PASSWORD@ matomo -e 'UPDATE user SET token_auth = "@MATOMO_PUBLIC_USER_APIKEY@" WHERE login = "@MATOMO_PUBLIC_USER@";'
