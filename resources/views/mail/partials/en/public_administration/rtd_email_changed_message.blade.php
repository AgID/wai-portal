...
as Head of the Digital Transition we inform you that
...
{{ $earliestRegisteredAdministrator->full_name }} who {{ $publicAdministration->status->is(PublicAdministrationStatus::PENDING) ? 'registered' : 'manages' }}
