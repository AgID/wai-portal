    ...
    <div class="form-row">
        <div class="form-group col">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $user->name ?? '') }}" placeholder="{{ __('inserisci il nome del nuovo utente') }}" aria-required="true" required>
                @error('name')
    ...
    <div class="form-row">
        <div class="form-group col">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="family_name" name="family_name" value="{{ old('family_name', $user->family_name ?? '') }}" placeholder="{{ __('inserisci il cognome del nuovo utente') }}" aria-required="true" required>
                @error('family_name')
