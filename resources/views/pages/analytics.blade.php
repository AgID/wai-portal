...
<div class="container py-3">
    ...
    <div class="row">
                ...
                <div class="card card-bg">
                    <div class="card-body">
                        ...
                        <iframe
                            ...
                            src=""
                            data-src="{{ config('analytics-service.widgets_domain') }}{{ config('analytics-service.widgets_base_url') }}/{{ $widget['url'] }}&token_auth={{ $publicAdministration->token_auth }}&idSite={{ $publicAdministration->rollup_id }}&show_related_reports=0&language={{ $locale }}"
                            frameborder="0"
                            width="100%"
                            height="350"
                            marginheight="0"
        ...
        @endforeach
        <script>widgets_domain = "{{ config('analytics-service.widgets_domain') }}"</script>
    </div>
    @else
