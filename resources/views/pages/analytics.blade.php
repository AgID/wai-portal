                ...
                <div class="card card-bg">
                    <div class="card-body">
                        ...
                        <iframe
                            ...
                            src=""
                            data-src="{{ config('analytics-service.widgets_url') }}/{{ $widget['url'] }}&token_auth={{ $publicAdministration->token_auth }}&idSite={{ $publicAdministration->rollup_id }}&show_related_reports=0&language={{ $locale }}"
                            frameborder="0"
                            width="100%"
                            height="350"
                            marginheight="0"
